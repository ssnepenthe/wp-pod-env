 ...
 * @param {string} cacheDirectoryPath  Path to the work directory located in ~/.wp-pod-env.
 *
 ...
 * @param {string} options.cacheDirectoryPath Path to the work directory located in ~/.wp-pod-env.
 *
